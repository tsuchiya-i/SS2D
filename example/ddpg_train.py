...
def main():
    ...
    #theta:minrandom, #sigma:maxrandom
    random_process = OrnsteinUhlenbeckProcess(size=nb_actions, theta=.1, mu=0.0, sigma=.3)#theta:minrandom
    ...
    # Ctrl + C.
    nb_steps_ = 10000000000
    nb_max_episode_steps_ = 1500
    
    train_history = agent.fit(env, nb_steps=nb_steps_, visualize=True, verbose=1, nb_max_episode_steps=nb_max_episode_steps_, callbacks=[tensorboard_callback])
